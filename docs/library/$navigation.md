...
- **外功修炼**
    ...
    - **平台学习**
        ...
        - [在Windows下部署伪Linux环境](?file=002-开发爪印/03-外功修炼/07-平台学习/03-在Windows下部署伪Linux环境 "在Windows下部署伪Linux环境")
...
- [项目规范之美](?file=003-碎碎念/05-项目规范之美 "项目规范之美")
...
- **工具学习**
    ...
    - **开发套件**
        ...
        - [msys2和cmder](?file=004-零碎记忆/02-工具学习/03-开发套件/03-msys2和cmder "msys2和cmder")
    - **零散工具**
        - **Git**
